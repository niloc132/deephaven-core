...
public enum FieldType {
    ...
    @com.google.common.annotations.GwtIncompatible public boolean isValidForField(Field field) {
    ...
    @com.google.common.annotations.GwtIncompatible private boolean isValidForList(Field field) {
     ...
     */
    @com.google.common.annotations.GwtIncompatible private static Type getGenericSuperList(Class<?> clazz) {
     ...
     */
    @com.google.common.annotations.GwtIncompatible private static Type getListParameter(Class<?> clazz, Type[] realTypes) {
        top:
