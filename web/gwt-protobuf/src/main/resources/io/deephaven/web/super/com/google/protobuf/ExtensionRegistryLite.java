...
public class ExtensionRegistryLite {
    ...
    private static boolean doFullRuntimeInheritanceCheck = false;

    // Visible for testing.
    static final String EXTENSION_CLASS_NAME = "com.google.protobuf.Extension";

    @com.google.common.annotations.GwtIncompatible private static class ExtensionClassHolder {
     ...
     */
    @com.google.common.annotations.GwtIncompatible public final void add(ExtensionLite<?, ?> extension) {
        ...
        if (doFullRuntimeInheritanceCheck && ExtensionRegistryFactory.isFullRegistry(this)) {
            try {
                ...
                throw new IllegalArgumentException(
                        String.format("Could not invoke ExtensionRegistry#add for " + extension), e);
            }
        }
    }
