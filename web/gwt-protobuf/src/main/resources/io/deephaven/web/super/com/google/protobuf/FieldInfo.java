...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    private final Object presenceField;
    private final int presenceMask;
    private final boolean required;
    private final boolean enforceUtf8;
    private final OneofInfo oneof;
    private final Object cachedSizeField;
    /**
    ...
    public static FieldInfo forField(
            Object field, int fieldNumber, FieldType fieldType, boolean enforceUtf8) {
    ...
    public static FieldInfo forPackedField(
            Object field, int fieldNumber, FieldType fieldType, Object cachedSizeField) {
        checkFieldNumber(fieldNumber);
        checkNotNull(field, "field");
        checkNotNull(fieldType, "fieldType");
        if (fieldType == FieldType.MESSAGE_LIST || fieldType == FieldType.GROUP_LIST) {
    ...
    public static FieldInfo forRepeatedMessageField(
            Object field, int fieldNumber, FieldType fieldType, Class<?> messageClass) {
        checkFieldNumber(fieldNumber);
        checkNotNull(field, "field");
        checkNotNull(fieldType, "fieldType");
    ...
    public static FieldInfo forFieldWithEnumVerifier(
            Object field, int fieldNumber, FieldType fieldType, EnumVerifier enumVerifier) {
        checkFieldNumber(fieldNumber);
        checkNotNull(field, "field");
        return new FieldInfo(
                field,
    ...
    public static FieldInfo forMapField(
            Object field, int fieldNumber, Object mapDefaultEntry, EnumVerifier enumVerifier) {
    ...
    public Object getPresenceField() {
    ...
    public Object getCachedSizeField() {
    ...
    public static final class Builder {
        ...
        private Object cachedSizeField;
         ...
         */
        public Builder withField(Object field) {
            if (oneof != null) {
        ...
        public Builder withPresence(Object presenceField, int presenceMask) {
        ...
        public Builder withCachedSizeField(Object cachedSizeField) {
            this.cachedSizeField = cachedSizeField;
            return this;
        }
