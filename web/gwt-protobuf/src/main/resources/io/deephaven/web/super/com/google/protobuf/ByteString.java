...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    static {
        byteArrayCopier =
                /*Android.isOnAndroidDevice()*/false ? new SystemByteArrayCopier() : new ArraysByteArrayCopier();
    }
    ...
    public static final class Output extends OutputStream {
        ...
        public String toString() {
            return "<ByteString.Output@"+Integer.toHexString(System.identityHashCode(this))+" size="+size()+">";
        }
    ...
    public final String toString() {
        return "<ByteString@"+toHexString(identityHashCode(this))+" size="+size()+" contents=\""+truncateAndEscapeForDisplay()+"\">";
    }
    ...
    private static class LiteralByteString extends ByteString.LeafByteString {
        ...
        public final ByteBuffer asReadOnlyByteBuffer() {
            throw new UnsupportedOperationException("ByteBuffer.wrap(byte[], offset, length) is not supported");
//            return ByteBuffer.wrap(bytes, getOffsetIntoBytes(), size()).asReadOnlyBuffer();
    ...
    private static final class BoundedByteString extends LiteralByteString {
        ...
        @com.google.common.annotations.GwtIncompatible Object writeReplace() {
            return ByteString.wrap(toByteArray());
        }

        @com.google.common.annotations.GwtIncompatible private void readObject(@SuppressWarnings("unused") ObjectInputStream in) throws IOException {
