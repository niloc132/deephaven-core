...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public final void writeFloat(final int fieldNumber, final float value) throws IOException {
        writeFixed32(fieldNumber, Numbers.floatToIntBits(value));
    }
    ...
    public final void writeFloatNoTag(final float value) throws IOException {
        writeFixed32NoTag(Numbers.floatToIntBits(value));
    }
    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        ArrayEncoder(byte[] buffer, int offset, int length) {
            ...
            if ((offset | length | (buffer.length - (offset + length))) < 0) {
                throw new IllegalArgumentException("Array range is invalid. Buffer.length="+buffer.length+", offset="+offset+", length="+length);
            }
            this.buffer = buffer;
            this.offset = offset;
            position = offset;
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            try {
                ...
                throw new OutOfSpaceException("Pos: "+position+", limit: "+limit+", len: 1", e);
            }
        }
