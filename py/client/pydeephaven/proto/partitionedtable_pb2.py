...
PartitionedTableDescriptor = _reflection.GeneratedProtocolMessageType('PartitionedTableDescriptor', (_message.Message,), {
  'DESCRIPTOR' : _PARTITIONEDTABLEDESCRIPTOR,
  '__module__' : 'pydeephaven.proto.partitionedtable_pb2'
...
_PARTITIONEDTABLESERVICE = DESCRIPTOR.services_by_name['PartitionedTableService']
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'H\001P\001ZMgithub.com/deephaven/deephaven-core/go-client/internal/proto/partitionedtable'
