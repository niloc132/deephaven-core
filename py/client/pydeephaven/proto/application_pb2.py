...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'H\001P\001ZHgithub.com/deephaven/deephaven-core/go-client/internal/proto/application'
